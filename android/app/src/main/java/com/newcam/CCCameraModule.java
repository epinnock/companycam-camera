...
//        imageproc.debugPrint("[CCCamera]");

        // Load file to bitmapInput
        ...
        Bitmap bitmapOutput = imageproc.apply(bitmapInput);
        ...
        waOutputDims.pushInt(bitmapOutput.getWidth());
        waOutputDims.pushInt(bitmapOutput.getHeight());
