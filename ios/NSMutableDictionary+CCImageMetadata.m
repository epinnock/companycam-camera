...
@implementation NSMutableDictionary (CCImageMetadataCategory)
...
- (NSMutableDictionary *)mutableDictionaryForKey:(CFStringRef)key
{
...
#define EXIF_DICT [self mutableDictionaryForKey:kCGImagePropertyExifDictionary]
#define TIFF_DICT [self mutableDictionaryForKey:kCGImagePropertyTIFFDictionary]
#define IPTC_DICT [self mutableDictionaryForKey:kCGImagePropertyIPTCDictionary]
